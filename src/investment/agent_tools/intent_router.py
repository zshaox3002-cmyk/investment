...
_SKILLS: list[SkillDef] = [
    ...
    # ── Phase 8: 研究分析类 Skills (⑩-⑭) ──────────────────────────────────
    SkillDef(
        skill_id="ic_memo",
        name="买入决策备忘录（IC Memo）",
        priority=1,
        keywords=[
            "买入分析", "建仓分析", "投资决策", "买入备忘录", "IC Memo",
            "能不能买", "值得买入", "买入前分析", "深度分析", "五支柱",
            "三情景", "目标价", "仓位建议", "帮我分析一下这只股票",
        ],
    ),
    SkillDef(
        ...
        priority=1,
        keywords=[
            "估值对比", "同业比较", "comps", "估值分析", "可比公司",
            "便宜还是贵", "估值贵吗", "横向对比", "PE对比", "估值比较",
            "对比一下估值", "同业估值", "估值", "对比", "同业",
            "贵不贵", "便宜", "比较一下估值", "估值水平",
        ],
    ),
    SkillDef(
        ...
        priority=1,
        keywords=[
            "更新评分", "论点跟踪", "月度复盘", "论点审查", "评分卡",
            "支柱状态", "thesis跟踪", "论点更新", "月度评分", "持仓论点",
            "检查论点", "thesis评分", "评分卡更新", "持仓评分",
            "论点还成立", "检查持仓论点",
        ],
    ),
    SkillDef(
        ...
        priority=1,
        keywords=[
            "财报分析", "业绩解读", "earnings", "财报验证", "季报", "年报",
            "业绩报告", "发财报了", "财报解读", "业绩怎么样", "财报数据",
            "营收分析", "利润分析", "分析财报", "业绩分析", "发财报",
        ],
    ),
    SkillDef(
        ...
        priority=1,
        keywords=[
            "候选池刷新", "量化筛选", "每月选股", "系统扫描", "标的扫描",
            "月度扫描", "候选池扫描", "创意生成", "新机会", "找机会",
            "全市场扫描", "合规检查", "候选标的", "候选池",
            "扫描候选", "筛选候选", "全市场",
        ],
    ),
